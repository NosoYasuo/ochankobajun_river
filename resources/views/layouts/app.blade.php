  ...
  <div id="app">
    <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background-color: #81d8d0;">
      <div class="container">
        ...
        @auth
        <!-- モーダルを表示させるボタン-->
        <button type="button" class="input_button border-0 rounded-pill text-secondary px-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item dropdown">
            <h6 id="navbarDropdown pr-0" class="dropdown-item" style="color: #212529" onMouseOut="this.style.background=''" onMouseOver="this.style.background='#81d8d0'">{{ Auth::user()->name }} さん</h6>
