        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <a href="https://www.kasen-suibo.metro.tokyo.lg.jp/im/uryosuii/tsim0102g.html" class="dropdown-item" style="color: #ffffff" onMouseOut="this.style.background=''" onMouseOver="this.style.background='#81d8d0'"><svg xmlns="http://www.w3.org/2000/svg" class="mb-2" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
